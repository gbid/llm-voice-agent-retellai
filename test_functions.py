...
class TestVerifyPackage:
    ...
    def test_verify_success(self, setup):
        ...
        response = client.post("/api/functions/verify_package", json={
...
class TestReschedule:
    ...
    def test_reschedule_success(self, mock_email, setup):
        ...
        response = client.post("/api/functions/reschedule", json={
...
class TestEscalate:
    ...
    def test_escalate_success(self, mock_email, setup):
        ...
        mock_email.return_value = True
        response = client.post("/api/functions/escalate", json={
            "tracking_number": "PKG001",
            "postal_code": "12345"
        })
        assert response.status_code == 200
