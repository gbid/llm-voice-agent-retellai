...
def init_database():
    ...
    seed_packages = [
        ("PKG001", "John Smith", "+1234567890", "john@example.com", "12345", "Main St", "123", "out_for_delivery", tomorrow),
        ("PKG002", "Jane Doe", "+1987654321", "jane@example.com", "67890", "Oak Ave", "456", "scheduled", tomorrow + timedelta(hours=2)),
        ("PKG003", "Bob Wilson", "+1122334455", "bob@example.com", "54321", "Pine Rd", "789", "delivered", datetime.now()),
    ]
